...
function showUploadResult(uploadResultArr){
	...
	$(uploadResultArr).each(function(i,obj){
		...
		if(obj.filetype){
			...
			str+="<img src='../img/diskette_blue.png' class='diskette'>";
			str+="<span>"+obj.filename+"</span>";
			str+="<img src='/blacksigma/display?filename="+fileCallPath+"'>";
			str+="<button type='button' class='btn btn-warning btn-circle'><i class='fa fa-times'></i>삭제</button>";
			str+="</div></li>";
		}else{// 그렇지 않은 형태
			...
			str+="<button type='button' data-file=\'" + fileCallPath + "\' data-type='file' class='btn btn-warning btn-circle'><i class='fa fa-times'></i>닫기</button>";
			str+="</div></li>";
